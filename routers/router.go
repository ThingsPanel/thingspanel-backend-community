...
func init() {
	...
	api := web.NewNamespace("/api",
		...
		// 设备事件上报/命令下发历史列表
		web.NSRouter("/device/event/history/list", &controllers.DeviceController{}, "*:DeviceEventList"),
		web.NSRouter("/device/command/history/list", &controllers.DeviceController{}, "*:DeviceCommandList"),
