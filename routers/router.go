...
func Init() {
	...
	api := web.NewNamespace("/api",
		...
		web.NSRouter("/user/tenant/config/index", &controllers.UserController{}, "*:TenantConfigIndex"),
		web.NSRouter("/user/tenant/config/save", &controllers.UserController{}, "*:TenantConfigSave"),
