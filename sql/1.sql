...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('5373a6a2-1861-af35-eb4c-adfd5ca55ecd', '0', 'device', 1, 112, '/device', 'icon-park-outline:workbench', '0', '["TENANT_ADMIN","SYS_ADMIN"]'::json, '设备接入', '2024-03-05 17:51:19.298', '', 'route.device', 'layout.base');
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('7419e37e-c167-f12b-7ace-76e479144181', '5373a6a2-1861-af35-eb4c-adfd5ca55ecd', 'device_template', 3, 1127, '/device/template', 'simple-icons:apacheecharts', 'self', '["TENANT_ADMIN","SYS_ADMIN"]'::json, '功能模板', '2024-03-05 18:01:29.826', '定义物模型和显示图表', 'route.device_template', 'view.device_template');
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('774a716d-9861-bac9-857f-acaa25e7659f', '5373a6a2-1861-af35-eb4c-adfd5ca55ecd', 'device_config', 3, 1126, '/device/config', 'clarity:plugin-line', 'self', '["TENANT_ADMIN","SYS_ADMIN"]'::json, '配置模板', '2024-03-05 22:06:53.842', '设备的协议和其他参数等所有配置', 'route.device_config', 'view.device_config');
