...
INSERT INTO public.users (id, "name", phone_number, email, status, authority, "password", tenant_id, remark, additional_info, created_at, updated_at) VALUES('50', 'admin', '1231231321', 'super@super.cn', 'N', 'SYS_ADMIN', '$2a$10$dPDIqoOEt.rSDwEWsSHCqe9/PJEsnWvRK76DwXVZUFM/7J0D3ikfq', '', 'dolor', '{}'::json, NULL, '2024-03-06 14:52:52.390');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('ce034f31-e509-a281-d767-4d8bc051a9f8', '0', 'product', 1, 116, '/product', 'icon-park-outline:editor', 'self', '["TENANT_ADMIN"]'::json, '产品管理', '2024-02-22 15:14:12.294', '', 'route.product', 'layout.base');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('954e6c24-8809-f540-b3f4-748e5877d793', 'e1ebd134-53df-3105-35f4-489fc674d173', 'management_role', 3, 1172, '/management/role', 'ph:android-logo', 'self', '["TENANT_ADMIN"]'::json, '角色管理', '2024-03-07 22:24:31.144', '', 'route.management_role', 'view.management_role');
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('4b9cddf4-4cbe-6998-78d2-d1181eb8cc7b', 'e1ebd134-53df-3105-35f4-489fc674d173', 'management_ordinary-user', 3, 1173, '/management/ordinary-user', 'uil:brightness-plus', 'self', '["TENANT_ADMIN"]'::json, '用户管理', '2024-03-07 22:24:03.116', '', 'route.management_ordinary-user', 'view.management_ordinary-user');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('c1846f2a-17a5-c1c4-94dc-61cbb893ce6a', '95e2a961-382b-f4a6-87b3-1898123c95bc', 'visualization_big-screen', 3, 1, '/visualization/big-screen', 'tabler:device-tv', 'self', '["TENANT_ADMIN"]'::json, '大屏', '2024-03-17 13:19:14.198', '', 'route.visualization_big-screen', 'view.visualization_big-screen');
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('2169d654-676c-1a83-c4c8-89d3a872da86', '0', 'edit-area', 3, 1, '/edit-area', '', '1', '["TENANT_ADMIN"]'::json, '编辑空间', '2024-04-01 02:57:00.150', '', 'route.edit-area', 'layout.base$view.edit-area''');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('de11a510-6b35-37fb-d739-e1fd33c487f8', '0', 'space-management', 3, 999, '/space-management', 'mdi:card-outline', '1', '["TENANT_ADMIN"]'::json, '空间管理', '2024-03-20 10:06:09.357', '', 'route.space-management', 'layout.base$view.space-management');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('5e9abecb-ca1c-4678-a41b-5a2f028243d9', '0', 'new-area', 3, 1, '/new-area', '', '1', '["TENANT_ADMIN"]'::json, '新增空间', '2024-04-01 02:57:43.191', '', 'route.new-area', 'layout.base$view.new-area');
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('2b819298-2560-c5b7-e2d2-ab0e828d4eac', '2cc0c5ba-f086-91e5-0b8c-ad0546b1f2a9', 'test_kan-ban-details-test', 3, 1, '/test/kan-ban-details-test', '', '1', '["SYS_ADMIN","TENANT_ADMIN"]'::json, '详情测试', '2024-05-21 01:16:34.809', '', 'route.test_kan-ban-details-test', 'view.test_kan-ban-details-test');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('9a11b3e4-9982-a0f0-996c-a9be6e738947', '0', 'data-service', 1, 2, '/data-service', 'mdi:monitor-dashboard', 'self', '["SYS_ADMIN"]'::json, '数据服务', '2024-03-07 17:05:04.101', '', 'route.data-service', 'layout.base');
