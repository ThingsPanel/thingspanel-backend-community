...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('e186a671-8e24-143a-5a2c-27a1f5f38bf3', '5373a6a2-1861-af35-eb4c-adfd5ca55ecd', 'device_config-edit', 3, 1128, '/device/template/edit', '', '1', '["TENANT_ADMIN"]'::json, '设备模板编辑', '2024-03-11 21:49:34.952', '', 'route.device_config-edit', 'view.device_config-edit');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('7419e37e-c167-f12b-7ace-76e479144181', '5373a6a2-1861-af35-eb4c-adfd5ca55ecd', 'device_template', 3, 1127, '/device/thingmodel', 'simple-icons:apacheecharts', 'self', '["TENANT_ADMIN"]'::json, '物模型', '2024-03-05 18:01:29.826', '旧物模型壳子，继续承载字段绑定和 Web/App 图表配置', 'route.device_template', 'view.device_template');
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('774a716d-9861-bac9-857f-acaa25e7659f', '5373a6a2-1861-af35-eb4c-adfd5ca55ecd', 'device_config', 3, 1126, '/device/template', 'clarity:plugin-line', 'self', '["TENANT_ADMIN"]'::json, '设备模板', '2024-03-05 22:06:53.842', '设备的协议和其他参数等所有配置', 'route.device_config', 'view.device_config');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('86cb08fa-8b08-3d99-4b3a-d6132ee93a0f', '5373a6a2-1861-af35-eb4c-adfd5ca55ecd', 'device_config-detail', 3, 1127, '/device/template/detail', 'icon-park-outline:data-server', '1', '["TENANT_ADMIN"]'::json, '设备模板详情', '2024-03-10 11:13:25.253', '', 'route.device_config-detail', 'view.device_config-detail');
