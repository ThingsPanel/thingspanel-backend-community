...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('075d9f19-5618-bb9b-6ccd-f382bfd3292b', '5373a6a2-1861-af35-eb4c-adfd5ca55ecd', 'device_integration', 3, 1129, '/device/integration', 'mdi:ab-testing', '0', '["TENANT_ADMIN"]'::json, '三方集成', '2024-07-01 21:52:09.402', '', 'route.device_integration', '');
