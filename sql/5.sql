...
VALUES('cf168132-3cde-a0e2-6772-e3a28fca4a59', 'e1ebd134-53df-3105-35f4-489fc674d173', 'management_api', 3, 1, '/management/api', 'icon-park-outline:editor', '0', '["TENANT_ADMIN"]'::json, 'API key', '2025-02-14 18:38:42.007', '', 'route.management_api', '');
