<template>
  <div class="chart-all-gG7dB0">
    <div class="chart-top-gG7dB0">
      <div style="
      text-align:center;
      color: #fff;
      width: 100%;
    ...
    <div class="chart-body-gG7dB0" :id="'chart_' + id"></div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    watch: {
      apiData: {
        ...
        immediate: true,
        handler(val, oldVal) {
          console.log("01-gG7dB0-图表接收到数据");
          console.log("02-gG7dB0-图表id:" + this.id);
          if (val["fields"]) {
            console.log("03-gG7dB0-fields有值");
            console.log("04-gG7dB0-device_id:" + val["device_id"]);
            this.latest = val["latest"];
            this.fields = val["fields"];
            this.getData();
          } else {
            console.log("05-gG7dB0-fields没有值");
          }
        },
      },
      colorStart() { },
