// Code generated by 'ccgo sys/random/gen.c -crt-import-path "" -export-defines "" -export-enums "" -export-externs X -export-fields F -export-structs "" -export-typedefs "" -header -hide _OSSwapInt16,_OSSwapInt32,_OSSwapInt64 -ignore-unsupported-alignment -o sys/random/random_illumos_amd64.go -pkgname random', DO NOT EDIT.
...
const (
	...
	GRND_NONBLOCK                   = 0x0001               // random.h:73:1:
	GRND_RANDOM                     = 0x0002               // random.h:74:1:
	...
	X_SYS_ATOMIC_H                  = 0                    // atomic.h:30:1:
	...
	X_SYS_RANDOM_H                  = 0                    // random.h:31:1:
...
// stats for the random number devices, /dev/random and /dev/urandom.
type Rnd_stats_t = Rnd_stats /* random.h:45:3 */

// stats for the kernel random number provider, swrand.
type Swrand_stats = struct {
	Fss_entEst   uint32
	F__ccgo_pad1 [4]byte
	Fss_entIn    uint64
	Fss_entOut   uint64
...
// stats for the kernel random number provider, swrand.
type Swrand_stats_t = Swrand_stats /* random.h:55:3 */
