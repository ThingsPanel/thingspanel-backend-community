// Code generated by 'ccgo sys/random/gen.c -crt-import-path "" -export-defines "" -export-enums "" -export-externs X -export-fields F -export-structs "" -export-typedefs "" -header -hide _OSSwapInt16,_OSSwapInt32,_OSSwapInt64 -ignore-unsupported-alignment -o sys/random/random_linux_loong64.go -pkgname random', DO NOT EDIT.
...
const (
	...
	GRND_INSECURE                = 0x04          // random.h:28:1:
	GRND_NONBLOCK                = 0x01          // random.h:26:1:
	GRND_RANDOM                  = 0x02          // random.h:27:1:
	...
	X_SYS_RANDOM_H               = 1             // random.h:20:1:
