// Code generated by 'ccgo dirent/gen.c -crt-import-path "" -export-defines "" -export-enums "" -export-externs X -export-fields F -export-structs "" -export-typedefs "" -header -hide _OSSwapInt16,_OSSwapInt32,_OSSwapInt64 -ignore-unsupported-alignment -o dirent/dirent_illumos_amd64.go -pkgname dirent', DO NOT EDIT.
...
const (
	...
	MAXGETDENTS_SIZE                = 65536      // dirent.h:94:1:
	MAXNAMLEN                       = 512        // dirent.h:46:1:
	...
	X_SYS_DIRENT_H                  = 0          // dirent.h:33:1:
...
// File-system independent directory entry.
type Dirent_t = Dirent /* dirent.h:49:3 */
...
// transitional large file interface version AND kernel internal version
type Dirent64_t = Dirent64 /* dirent.h:74:3 */
