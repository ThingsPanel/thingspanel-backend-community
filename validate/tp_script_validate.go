...
type TpScriptTestValidate struct {
	ScriptContent string `json:"script_content,omitempty" alias:"脚本内容" valid:"MaxSize(10000)"`
	MsgContent    string `json:"msg_content,omitempty" alias:"消息内容" valid:"MaxSize(10000)"`
