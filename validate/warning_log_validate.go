...
type WarningLogPageListValidate struct {
	AssetId    string `json:"asset_id,omitempty" alias:"资产id" valid:"MaxSize(36)"`
	BusinessId string `json:"business_id,omitempty" alias:"业务id" valid:"MaxSize(36)"`
	DeviceId   string `json:"device_id,omitempty" alias:"设备id" valid:"MaxSize(36)"`
	StartDate  string `json:"start_date,omitempty" alias:"开始时间" valid:"MaxSize(36)"`
	EndDate    string `json:"end_date,omitempty" alias:"结束时间" valid:"MaxSize(36)"`
	Page       int    `json:"page" alias:"页码" valid:"Min(1)"`
	Limit      int    `json:"limit" alias:"条数" valid:"Max(999)"`
}
