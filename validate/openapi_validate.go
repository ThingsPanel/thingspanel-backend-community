...
type AddOpenapiAuthValidate struct {
	...
	IpWhitelist       string `json:"ip_whitelist,omitempty" alias:"ip白名单"  valid:"MaxSize(500)"`
...
type ApiValidate struct {
	...
	ApiType     string `json:"api_type,omitempty" alias:"接口类型"  valid:"Required,MaxSize(20)"`
